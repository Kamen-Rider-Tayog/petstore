...
<head>
    ...
    <title>Terms of Service - Pet Store</title>
            ...
            <div class="terms-container">
                ...
                <div class="terms-body">
                    <div class="terms-section">
                        ...
                        <p>Welcome to Pet Store. These Terms of Service ("Terms") govern your use of our website, services, and products. By accessing or using our services, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use our services.</p>
                        <p>These Terms apply to all visitors, users, and others who access or use our services.</p>
                    </div>

                    <div class="terms-section">
                        <h2>2. Description of Service</h2>
                        <p>Pet Store provides an online platform for purchasing pet supplies, scheduling veterinary appointments, grooming services, and pet boarding. Our services include:</p>
                        <ul>
                    ...
                    <div class="terms-section">
                        ...
                        <p>All content on our website, including text, graphics, logos, and software, is owned by Pet Store or our licensors and is protected by copyright and trademark laws. You may not reproduce, distribute, or create derivative works without our express written permission.</p>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <p>You agree to indemnify and hold Pet Store harmless from any claims, damages, losses, or expenses arising from your use of our services or violation of these Terms.</p>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="contact-info">
                            ...
                            <p><strong>Email:</strong> legal@petstore.com</p>
                            <p><strong>Phone:</strong> (555) 123-4567</p>
                            <p><strong>Address:</strong> 123 Pet Street, Animal City, AC 12345</p>
                            <p><strong>Legal Department:</strong> legal@petstore.com</p>
                        </div>
                    </div>

                    <div class="terms-section">
                        <p><em>By using Pet Store services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</em></p>
                    </div>
                </div>
            </div>
        </div>
